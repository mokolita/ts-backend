...
loc1 = Location.create(name: 'Winter Park', content: 'Vazquez Rd: Just keep driving back until it turns to dirt. Then look for a spot!', latitude: '31.08', longitude: '45.0038', user: meg)
loc2 = Location.create(name: 'Crested Butte', content: 'More dirt road and OFF ROADING. 4x4 is a MUST.', latitude: '42.03839', longitude: '12.298543', user: jason)
